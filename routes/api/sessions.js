...
// @desc   Add a user to a session using their email address
// @access Private
...
// @desc   Remove a user from a session / Leave a session
// @access Private
router.delete(
...
// @desc   Add a search result to the list of highlighted queries
// @access Private
router.put(
...
// @desc   Remove a search result from the list of highlighted queries
// @access Private
router.delete(
...
// @route  POST api/sessions
// @desc   Add a query to the database
// @access Private
router.post(
  "/:session_id",
  [
